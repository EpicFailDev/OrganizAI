...
// ----------------------------------------------------
export const TransactionTypeSchema = z.enum(['expense', 'income', 'transfer']).openapi('TransactionType');
...
export const TransactionSchema = z.object({
  ...
  category_id: z.string().uuid().nullable().optional().openapi({ example: 'a1b2c3d4-0000-0000-0000-000000000001' }),
  date: z.string().openapi({ example: '2026-08-08' }),
  family_id: z.string().uuid().nullable().optional(),
  profile_id: z.string().uuid().nullable().optional(),
  notes: z.string().nullable().optional().openapi({ example: 'Compra realizada no Carrefour' }),
...
export const CreateTransactionSchema = z.object({
  ...
  category_id: z.string().uuid().optional().openapi({ example: 'a1b2c3d4-0000-0000-0000-000000000001' }),
  subcategory_id: z.string().uuid().nullable().optional(),
  date: z.string().openapi({ example: '2026-08-08' }),
  notes: z.string().optional().openapi({ example: 'Restaurante' }),
...
export const FinancialAnalyticsSummarySchema = z.object({
  ...
  top_category: z.string().openapi({ example: 'Alimentação' }),
